...
<section className="container px-28 ">
     ...
     <div  className="flex justify-start pt-6 ">
            ...
            <div className="border border-blue-100 bg-blue-500 px-2 text-white ms-6 Save_10">Reserve</div>
          
         </div>
         <div  className="flex justify-start pt-3 px-2">
         <FaMapMarkerAlt  className="w-2 " style={{color:'blue'}}/>

         <p className="Save_10 px-1">12 KM, Al Haya Road, Hurghada, Egypt – Great location - show map</p>
     ...
     <div className="flex px-2">
        ...
        <Image src={louxer2} alt="My Image" className=" pt-2"  width={200} height={200}/>
        ...
        <Image className="px-1 " src={louxer3} alt="My Image"  width={120} height={90}/>
        <Image className="px-1 " src={louxer4} alt="My Image"  width={120} height={90}/>
        <Image className="px-1 "  src={louxer3} alt="My Image"  width={120} height={90}/>
        <Image className="px-1 " src={miny} alt="My Image"  width={120} height={90}/>
      ...
      <div className="mb-3">
        ...
        <p className="text-gray-600  Save_10">
          "The breakfast menu and timing were excellent. Nile river and in the evening can watch..."
        </p>
      ...
      <div className="border-t  pt-4  flex">
        ...
        <div className="flex items-center mx-3">
          <div className="border border-black px-2 Save_10">
            9.1
          </div>
        </div>
      </div>
...
<PiPersonSimpleSwim style={{margin:'10px'}}/> 
    ...
    <p className="py-1 Save_10">Garden</p> 
      ...
      <div className="Save_10">
        <p>
        You're eligible for a Genius discount at Steigenberger Resort Achti! To save at this property,
     
        </p>
       <br/>
        <p>
        Get the celebrity treatment with world-class service at Steigenberger Resort Achti
        </p>
        <p>
        Located on the banks of the River Nile, Steigenberger Resort Achti is an 8-acre luxury resort set in lush tropical gardens.
        </p>
        <p>
        All rooms and suites at the Steigenberger Resort Achti are air-conditioned and have elegant furnishings. Each room is equipped with satellite flat-screen TV. The rooms offer views ranging from the Nile, 
        </p>
        <br/>
        <p>
        The two restaurants onsite are AlKarnak restaurant and terrace serving international cuisine and Niño’s Italian restaurant serving Italian dishes and pizza. Three bars         </p>
        <p>
        The centre of Luxor is located less than 3 km from the hotel. It is 2 km from Luxor Temple and Mummification Museum and 3 km from Luxor Museum. Steigenberger Resort Achti       </p>
        <p>
     ...
     <div className="max-w-md max-h-md  mx-auto bg-blue-200 border border-gray-300 p-2">
        ...
        <p className=" Save_10">Top location: Highly rated by recent guests (8.7)</p> 
