import { CalendarIcon, LocationMarkerIcon, ClockIcon, UserIcon } from '@heroicons/react/outline';

const TaxiBook = () => {
  return (
    <div className="flex flex-col items-center mt-10 bg-gray-100">
      <h1 className="text-2xl font-bold">Book your airport taxi</h1>
      <p className="text-gray-500">Easy transportation between the airport and your accommodations</p>

      <div className="flex justify-center items-center space-x-4 mt-4">
        <div className="flex items-center space-x-2">
          <input type="radio" id="oneway" name="trip" defaultChecked />
          <label htmlFor="oneway" className="text-blue-500">One-way</label>
          <input type="radio" id="return" name="trip" />
          <label htmlFor="return" className="text-gray-500">Return</label>
        </div>
      </div>
      ...
      <div className="flex justify-center items-center space-x-2 mt-4">
        ...
        <div className="flex items-center p-4 border-2 border-yellow-400 rounded-md">
          ...
          <input type="text" placeholder="25/09/2024" className="outline-none" />
        </div>
      ...
      <div className="flex justify-center items-center space-x-8 mt-8">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 text-center">Your driver will track your flight and wait for you if it's delayed</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 text-center">Your price is confirmed up front – no extra costs, no cash required</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 text-center">We work with professional drivers and have 24/7 customer care</p>
        </div>
      </div>
    </div>
  );
