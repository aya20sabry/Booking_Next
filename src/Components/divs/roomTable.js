...
const RoomTable = ({ hotel, availability, checkInDate, checkOutDate }) => {
  ...
  return (
    <>
      <div className="max-w-6xl mx-auto my-0 text-sm overflow-x-auto">
        {loading ? (
          ...
          <div className="min-w-[800px]">
            <table className="w-full" aria-label="room table">
              <thead>
                <tr>
              ...
              <tbody>
                {rooms.map((room, index) => (
                  <tr key={index} className="border-b-2 border-[#5BBAFF]">
                    <td className="p-2 sm:p-4 border-r border-[#5BBAFF] max-w-52">
                    ...
                    {index === 0 && (
                      <td
                        className="p-1 sm:p-2 items-start border-r border-[FFFFF] align-top"
                        rowSpan={3}
                      >
                        <div className="text-center">
                          <button className="bg-blue-600 text-white px-4 sm:px-12 py-2 rounded w-full text-sm sm:text-base">
                            <Link
